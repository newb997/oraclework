...
CREATE TABLE TB_BOOK(
    BK_NO  VARCHAR2(50) CONSTRAINT BOOK_PK PRIMARY KEY,
    BK_TITLE VARCHAR2(50) CONSTRAINT BOOK_NN_TITLE NOT NULL,
    BK_AUTHOR VARCHAR2(20) CONSTRAINT BOOK_NN_AUTHOR NOT NULL,
    BK_PRICE NUMBER,
    --BK_PUB_NO NUMBER CONSTRAINT BOOK_FK   FOREIGN KEY(TB_PUBLISHER)  ON DELETE CASCADE
    BK_PUB_NO NUMBER FOREIGN KEY(BOOK_FK) REFERENCES TB_PUBLISHER ON DELETE CASCADE
);
...
CREATE TABLE TB_MEMBER(
    ...
    ADDRESS VARCHAR2(70),
    PHONE VARCHAR2(13),
    STATUS  CHAR(1) CONSTRAINT MEMBER_CK_STA CHECK( STATUS IN('Y','N')) DEFAULT 'N',
...
CREATE TABLE TB_RENT (
    ...
    RENT_MEM_NO NUMBER FOREIGN KEY(RENT_FK_MEM) REFERENCES TB_MEMBER ON DELETE SET NULL,
    RENT_BOOK_NO NUMBER FOREIGN KEY(RENT_FK_BOOK)  REFERENCES TB_BOOK  ON DELETE SET NULL,
