    ...
    1. INSERT
        ...
        [표현식]
         1) INSERT INTO 테이블명 VALUES( 값1, 값2, 값3..... )
             ...
             부족하게 값을 넣었을 때 => not enough value 오류뜸
             값을 많이 넣었을 때 => too many value 오류
*/
INSERT INTO EMPLOYEE VALUES( 300, '이시영', '051117-1234567', 'leesseayoooung@elk.or.kr', '01032157784', 'D1', 'J5', 3500000, 0.2, 200, SYSDATE, NULL, DEFAULT );

INSERT INTO EMPLOYEE VALUES( 300, '이시영', '051117-1234567', 'leesseayoooung@elk.or.kr', '01032157784', 'D1', 'J5', 3500000, 0.2, 200, SYSDATE, NULL, DEFAULT );
INSERT INTO EMPLOYEE VALUES( 301, '이시영', '051117-1234567', 'leesseayoooung@elk.or.kr', '01032157784', 'D1', 'J5', 3500000, 0.2, 200, SYSDATE, NULL, NULL, NULL );  --값이 너무 많거나 적으면 오류
...
/*
    2)INSERT INTO 테이블명( 컬럼명, 컬럼명, 컬럼명... ) VALUES( 값, 값, 값.... )
        ...
        => 반드시 넣어야될 컬럼 : 기본키, NOT NULL
        단, 기본값( DEFAULT )가 지정되어 있는 컬럼은 NULL이 아닌 기본값이 들어감
*/
INSERT INTO EMPLOYEE( EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE ) VALUES( 301, '김지창', '031017-1234567', 'J1', SYSDATE );

INSERT INTO EMPLOYEE( HIRE_DATE, EMP_ID, JOB_CODE, EMP_NAME, EMP_NO ) VALUES( SYSDATE, 302, 'J1', '허수연', '031017-1234567' );
...
-- INSERT INTO EMP_DEPT( EMP_ID, EMP_NAME, DEPT_CODE, HIRE_DATE ) VALUES( 1,1,1,1 ); 이런방법도잇음
----------------------------------------------------------------------------------------------------------------------------------------------
...
UPDATE EMP_SALARY
SET SALARY = 4100000, BONUS = 0.25
WHERE EMP_NAME = '조정연';

-- 전체 사원의 급여를 기존 급여의 10% 인상한 금액으로 변경( 기존 급여 * 1.1 ) == ( 기존급여 + 기존급여 * 0.1 )
UPDATE EMP_SALARY
...
-- 이시영, 김지창, 허수연, 현정보, 선우정보 사원들의 급여와 보너스를 조정연 사원가 같도록 변경
UPDATE EMP_SALARY
SET ( SALARY, BONUS ) = ( SELECT SALARY, BONUS
                                             FROM EMPLOYEE
                                             WHERE EMP_NAME = '조정연' )
...
/*
    3. DELETE
        테이블에 저장된 데이터를 삭제하는 구문( 행 단위로 삭제 )
...
--JOB_CODE가 J1인 부서 삭제
DELETE FROM JOB
WHERE JOB_CODE = 'J1';      --제약조건에 위배되는 삭제는 할 수 없음
