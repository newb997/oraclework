...
SELECT EMP_NAME, SALARY * 12 AS 연봉, SALARY * 12 + BONUS AS 총수령액, (SALARY * 12 + BONUS) - (SALARY * 12 * 0.03) AS 실수령액 FROM EMPLOYEE;
...
SELECT EMP_NAME, SALARY, (SALARY * 12 + BONUS) - (SALARY * 12 * 0.03) AS 실수령액, HIRE_DATE FROM EMPLOYEE WHERE (SALARY * 12 + BONUS) >= 50000000;
...
SELECT EMP_NAME, DEPT_CODE, HIRE_DATE FROM EMPLOYEE WHERE (DEPT_CODE = 'D9' OR DEPT_CODE = 'D5') AND HIRE_DATE < TO_DATE('02/01/01', 'YY/MM/DD');
